        ...
        <div class="row">
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              <!-- logo  -->
              <div class="aa-logo" style="width: 400px; margin-top:10px">
                <!-- Text based logo -->
<!--                <a href="index.jsp">
                ...
                <!-- img based logo -->
                <a href="${pageContext.request.contextPath}/"><img src="${url}/images/logo_banner.png" alt="logo img" width="70%"></a> 
              </div>
              <!-- / logo  -->
              <!-- Shipping service -->
              <div class="aa-shipping-box">
                  ...
                  <a class="aa-shipping-boxsmall">
                      ...
                      <span class="aa-shipping-box-text">
                          <div class="aa-shipping-title">Hỗ trợ - Giao lưu:</div>
