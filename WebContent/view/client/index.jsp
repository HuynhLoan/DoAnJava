              ...
              <div class="col-md-5 no-padding">                
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    <img src="${url}/images/section3.jpg" alt="Sen đá bông hồng">                    
                    <div class="aa-prom-content">
                      <span>Giảm giá 35%</span>
                      <h4>Sen đá bông hồng</h4>                      
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/section2.jpg" alt="xương rồng sen đá">                      
                      <div class="aa-prom-content">
                        <span>Sản phẩm độc quyền</span>
                        <h4>Xương rồng sen đá</h4>                        
                      </div>
                    </div>
                  </div>
                  <div class="aa-single-promo-right">
              ...
              <div class="aa-product-inner">
                <!-- start prduct navigation -->
                 <ul class="nav nav-tabs aa-products-tab">
                    <li class="active"><a href="#hat" data-toggle="tab">Sen đá</a></li>
                    <li><a href="#raucu" data-toggle="tab">Xương rồng</a></li>
                    <li><a href="#traicay" data-toggle="tab">Chậu cây</a></li>
                    <li><a href="#matong" data-toggle="tab">Phụ kiện trang trí</a></li>
                  </ul>
                  <!-- Tab panes -->
      ...
      <div class="row">
        <div class="col-md-12">        
          <div class="row">
            ...
            <a href="#"><img src="${url}/images/banner_product.jpg" alt="banner trang chủ"></a>
          </div>
          </div>
        </div>
      </div>
            ...
            <ul class="aa-testimonial-slider">
              ...
              <li>
                ...
                <img class="aa-testimonial-img" src="${url}/images/avatar-1.jpg" alt="avatar 3">
                  <span class="fa fa-quote-left aa-testimonial-quote"></span>
                  <p>Nhiều lần đi làm bận rộn, không có thời gian ra cửa hàng nên tôi thường mua hàng online ở đây. Chất lượng sản phẩm và dịch vụ hướng dẫn chăm sóc cây ở đây rất là tốt!</p>
                  <div class="aa-testimonial-info">
                    <p>Nguyễn Văn C</p>
                    <span>Sinh viên</span>
                  </div>
