...
<c:url value = "/view/client/assets" var="url"/>
  ...
  <section id="aa-catg-head-banner">
   <img src="${pageContext.request.contextPath}/view/client/assets/images/banner_product.jpg" alt="banner sản phẩm">
  ...
  <section id="aa-product-category">
    <div class="container">
      <div class="row">
      	<div>
      		<h1 style ="text-align: center; color: red;">Các hình thức thanh toán của SENDA</h1>
      		<p>Hiện tại đối với các đơn hàng đặt hàng trực tuyến trên website, <strong>SENDA</strong> có những hình thức thanh toán như sau:</p>
      		<strong>* Thanh toán tiền mặt: </strong>
			<p>Sau khi nhận được đơn hàng trên website, bộ phận chăm sóc khách hàng của <strong>SENDA</strong> sẽ liên hệ lại xác nhận đơn hàng với khách hàng,
			...
			<p>Sau khi nhận được đơn hàng trên website, bộ phận chăm sóc khách hàng của <strong>SENDA</strong> sẽ xác nhận đơn hàng với khách hàng,
